...
const getVoices = upperFifthModulationOptions => {
  ...
  if (!isMinor) {
    voices = [
      ['=G42', '=F42', '=F42', '=E42', '=E42', '=D42', '=D42', '=C42', '=C42', '_B32:f', '_B32', '=A32', '=A32', '=G32', '=G32', '=F32'],
    ...
    voices = [
      ['=E52', '=D52', '=D52', '=C52', '=C52', '_B42:f', '_B42', '=A42', '=A42', '=G42', '=G42', '=F42', '=F42', '_E42:f', '_E42', '=D42'],
  ...
  const isNotCutable = numberOfSections === 1;
  options.addProps.confirmation[1] = isNotCutable;
  if (isNotCutable) {
    options.addProps.confirmation[0] = true;
  }
